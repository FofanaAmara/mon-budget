...
const CARD_COLORS = [
  ...
  },
  {
    key: "orange",
    value: "#EA580C",
    gradient: "linear-gradient(145deg, #EA580C 0%, #C2410C 100%)",
  },
];
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      if (modal.mode === "create") {
        ...
        await updateCard(modal.card.id, {
          name: name.trim(),
          last_four: lastFour || undefined,
          bank: bank || undefined,
          color,
      ...
      {modal.mode !== "closed" && (
        ...
        >
          <div
            ...
            tabIndex={-1}
            onKeyDown={(e) =>
              e.key === "Escape" && setModal({ mode: "closed" })
            }
          ...
          >
            ...
            >
              ...
              >
                <div>
                  <label htmlFor="card-last4" className="field-label">
                    4 derniers chiffres
                  </label>
                  <input
                    id="card-last4"
                ...
                <div>
                  <label htmlFor="card-bank" className="field-label">
                    Banque
                  </label>
                  <input
                    id="card-bank"
