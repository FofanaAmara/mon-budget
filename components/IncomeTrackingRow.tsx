...
export function IncomeInstanceRow({
  mi,
  index,
  isCurrentMonth,
  onMarkReceived,
    ...
    >
      <div style={{ padding: "12px 16px 12px 18px" }}>
        <div className="flex items-center" style={{ gap: "12px" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              {mi.income_frequency === "BIWEEKLY" &&
                mi.income_pay_anchor_date && (
                  <>
                    <span
                      style={{
                        width: "3px",
                    ...
                    >
                      Prochaine :{" "}
                      {formatShortDate(
                        getNextBiweeklyPayDate(mi.income_pay_anchor_date),
                      )}
                    </span>
                  </>
                )}
          ...
          >
            ...
            {isCurrentMonth &&
              (!isReceived ||
                (!mi.is_auto_deposited && isReceived) ||
        ...
        {expanded && isCurrentMonth && (
          <div
            className="flex"
            style={{ gap: "8px", marginTop: "12px", flexWrap: "wrap" }}
          >
            {!isReceived && (
              <button
                onClick={() => {
...
export function VariableIncomeRow({
  inc,
  index,
  isCurrentMonth,
  onMarkReceived,
          ...
          >
            ...
            >
              {inc.estimated_amount ? (
                <>~{formatCAD(Number(inc.estimated_amount))}</>
              ) : (
                "—"
              )}
            </span>
