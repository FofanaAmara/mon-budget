...
function toMonthly(amount: number, freq: Frequency): number {
  if (freq === "weekly") return amount * WEEKLY_MONTHLY_MULTIPLIER;
  if (freq === "biweekly") return amount * BIWEEKLY_MONTHLY_MULTIPLIER;
...
function previewLabel(amount: number, freq: Frequency): string {
  ...
  if (freq === "weekly")
    return `${fmt(amount)} × 4,33 = ${fmt(monthly)} $ / mois`;
  if (freq === "biweekly")
    return `${fmt(monthly)} $ / mois (basé sur 2× par mois)`;
...
export default function Onboarding({ onComplete }: Props) {
  ...
  function markDone() {
    ...
    const monthly = amount
      ? Math.round(toMonthly(parseFloat(amount), frequency))
      : 0;
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            >
              ...
              <path
                d="M12 28 C12 28, 16 24, 20 18 C24 12, 28 10, 28 10"
                stroke="white"
                strokeWidth="2.5"
                strokeLinecap="round"
                fill="none"
        ...
        >
          ...
          {step === 1 && (
            <div style={{ animation: "onb-step-in 0.4s ease both" }}>
              ...
              >
                ...
                <strong style={{ color: "#0F766E", fontWeight: 600 }}>
                  calculer ton budget automatiquement
                </strong>
                .
              </p>
                  ...
                  {(
                    ...
                    <button
                      ...
                      style={{
                        ...
                        padding: "10px 8px",
                        background:
                          frequency === opt.value ? "#F0FDFA" : "#FFFFFF",
          ...
          {step === 2 && (
            <div style={{ animation: "onb-step-in 0.4s ease both" }}>
              ...
              >
                Sélectionne les catégories de dépenses que tu utilises. Tu
                pourras les{" "}
                <strong style={{ color: "#0F766E", fontWeight: 600 }}>
                  modifier plus tard
                </strong>
              ...
              >
                ...
                catégorie{catCount !== 1 ? "s" : ""} sélectionnée
                {catCount !== 1 ? "s" : ""}
              </div>
          ...
          {step === 3 && (
            <div style={{ animation: "onb-step-in 0.4s ease both" }}>
              ...
              >
                Qu&apos;est-ce qui te motive à mieux gérer tes finances ?
                Choisis{" "}
                <strong style={{ color: "#0F766E", fontWeight: 600 }}>
              ...
              <div style={{ display: "flex", gap: "12px", marginTop: "28px" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "12px",
                    cursor:
                      hasObjective && !isPending ? "pointer" : "not-allowed",
                    letterSpacing: "-0.01em",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
