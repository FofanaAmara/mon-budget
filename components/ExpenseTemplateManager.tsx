...
export default function ExpenseTemplateManager({
  ...
  // ExpenseRow is now a top-level function component (see below the main export)
...
// ── ExpenseRow — extracted to top-level function (Clean Code M-11) ──────────
          ...
          {expense.card && (
            <>
              ...
              >
                ...
                {expense.card.name}
                {expense.card.last_four ? ` ····${expense.card.last_four}` : ""}
              </span>
            </>
          )}
        </div>
