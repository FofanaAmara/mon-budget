 ...
 * Extracted from inline SVGs duplicated across 10+ component files.
 * All icons use a 24x24 viewBox with stroke-based rendering (Feather-style).
 */
...
/** X / Close icon (two crossing lines) */
...
/** Plus / Add icon (vertical + horizontal lines) */
