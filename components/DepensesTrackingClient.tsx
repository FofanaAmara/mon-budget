...
export default function DepensesTrackingClient({
  ...
  const [editAmountSheet, setEditAmountSheet] = useState<MonthlyExpense | null>(
    null,
  );
  ...
  return (
    <div style={{ padding: "0 0 120px", minHeight: "100vh" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {paidTotal.toLocaleString("fr-CA", {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0,
              })}
            </p>
          ...
          >
            ...
            >
              ...
              {isOverBudget
                ? overAmount.toLocaleString("fr-CA", {
                    minimumFractionDigits: 0,
                    maximumFractionDigits: 0,
                  })
                : restAPayer.toLocaleString("fr-CA", {
                    minimumFractionDigits: 0,
                    maximumFractionDigits: 0,
                  })}
            </p>
        ...
        >
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  height: "42px",
                  borderRadius: "var(--radius-sm)",
                  background: actionSheet.section ? "#F0FDFA" : "#F1F5F9",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: "20px",
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  {actionSheet.section?.name ?? "—"}
                  {actionSheet.card
                    ? ` · ${actionSheet.card.name}${actionSheet.card.last_four ? ` ****${actionSheet.card.last_four}` : ""}`
                    : ""}
                </p>
              </div>
            </div>
            ...
            >
              ...
              {Number(actionSheet.amount).toLocaleString("fr-CA", {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0,
              })}
            </span>
          ...
          <div style={{ padding: "0 12px 8px" }}>
            ...
            {actionSheet.status !== "PAID" ? (
              <ActionItem
                ...
                onClick={() => {
                  handleToggle(actionSheet.id, "paid");
                  setActionSheet(null);
                }}
              />
            ) : (
              <ActionItem
                ...
                onClick={() => {
                  handleToggle(actionSheet.id, "upcoming");
                  setActionSheet(null);
                }}
              />
            )}
      ...
      {deferSheet && (
        <SheetWrapper
          onClose={() => setDeferSheet(null)}
          titleId="defer-sheet-title"
        >
          <div
            style={{
              display: "flex",
          ...
          <div style={{ padding: "0 20px 8px" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  ${Number(deferSheet.amount).toLocaleString("fr-CA")} ·{" "}
                  {deferSheet.section?.name ?? "—"}
                </p>
              </div>
            </div>
            ...
            >
              ...
              La dépense disparaîtra de ce mois et apparaîtra dans le mois
              choisi.
            </p>
          </div>
          <div
            style={{ display: "flex", gap: "10px", padding: "16px 20px 4px" }}
          >
            <button onClick={() => setDeferSheet(null)} style={btnCancelStyle}>
              Annuler
            </button>
            <button
      ...
      {editAmountSheet && (
        <SheetWrapper
          onClose={() => setEditAmountSheet(null)}
          titleId="edit-amount-sheet-title"
        >
          <div
            style={{
              display: "flex",
          ...
          <div style={{ padding: "0 20px 8px" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  Montant actuel: $
                  {Number(editAmountSheet.amount).toLocaleString("fr-CA")} ·{" "}
                  {editAmountSheet.section?.name ?? "—"}
                </p>
              </div>
            </div>
          ...
          >
            <button
              onClick={() => setEditAmountSheet(null)}
          ...
          <div style={{ textAlign: "center", padding: "8px 20px 0" }}>
            ...
            >
              <strong style={{ fontWeight: 700, color: "var(--slate-700)" }}>
                {deleteSheet.name} — $
                {Number(deleteSheet.amount).toLocaleString("fr-CA")}
              </strong>{" "}
              sera retiré de tes dépenses de {currentMonthLabel}. Cette action
              est irréversible.
            </p>
          </div>
          <div
            style={{ display: "flex", gap: "10px", padding: "20px 20px 4px" }}
          >
            <button onClick={() => setDeleteSheet(null)} style={btnCancelStyle}>
              Annuler
            </button>
            <button
