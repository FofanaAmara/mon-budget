...
export default function ProjetsEpargneClient({
  ...
  const [extraPayType, setExtraPayType] = useState<"regular" | "extra">(
    "regular",
  );
    ...
    <div style={{ padding: "0 0 120px", minHeight: "100vh" }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {freeSaved.toLocaleString("fr-CA", {
                    minimumFractionDigits: 0,
                    maximumFractionDigits: 0,
                  })}
                </p>
                ...
                >
                  <button
                    onClick={() => setSavingsModal(freeSavings)}
                    className="icon-btn"
                  ...
                  <button
                    onClick={() => setTransferModal(freeSavings)}
                    className="icon-btn"
                  ...
                  <button
                    onClick={() => setHistoryModal(freeSavings)}
                    className="icon-btn"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <button
                          onClick={() => setSavingsModal(projet)}
                          className="icon-btn"
                          aria-label="Ajouter épargne"
                        >
                          <svg
                        ...
                        <button
                          onClick={() => setTransferModal(projet)}
                          className="icon-btn"
                          aria-label="Transférer"
                        >
                          <svg
                        ...
                        <button
                          onClick={() => setHistoryModal(projet)}
                          className="icon-btn"
                          aria-label="Historique"
                        >
                          <svg
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      Mensualité{" "}
                      <strong
                        style={{ fontWeight: 700, color: "var(--slate-700)" }}
                      >
      ...
      {extraPayDebt && (
        <div
          ...
          onClick={(e) => e.target === e.currentTarget && setExtraPayDebt(null)}
          role="presentation"
        >
          <div
            className="sheet"
            ...
            tabIndex={-1}
            onKeyDown={(e) => e.key === "Escape" && setExtraPayDebt(null)}
          ...
          >
                    ...
                    <label key={type} style={{ flex: 1, cursor: "pointer" }}>
                      <input
                        ...
                        onChange={() => {
                          ...
                          if (type === "regular") {
                            setExtraPayAmount(
                              String(extraPayDebt?.payment_amount ?? ""),
                            );
                          }
                        }}
                        style={{ display: "none" }}
              ...
              <div style={{ marginBottom: "18px" }}>
                ...
                >
                  ...
                  <strong
                    style={{ fontWeight: 700, color: "var(--slate-700)" }}
                  >
                    {formatCAD(Number(extraPayDebt.payment_amount))}
                    {FREQ_LABELS[extraPayDebt.payment_frequency] ?? ""}
                  </strong>
                </p>
              </div>
                  ...
                  >
                    ...
                    >
                      {formatCAD(
                        Math.max(
                          0,
                          Number(extraPayDebt.remaining_balance) -
                            parseFloat(extraPayAmount),
                        ),
                      )}
                    </span>
                  </div>
            ...
            {/* Sheet actions */}
            <div
              style={{ display: "flex", gap: "10px", padding: "0 24px 24px" }}
            >
              <button
                onClick={() => {
                  setExtraPayDebt(null);
              ...
              >
                Payer{" "}
                {extraPayAmount ? formatCAD(parseFloat(extraPayAmount)) : ""}
              </button>
            </div>
          </div>
        </div>
      ...
      {chargeDebt && (
        <div
          className="sheet-backdrop"
          onClick={(e) => e.target === e.currentTarget && setChargeDebt(null)}
          role="presentation"
        >
          <div
            className="sheet"
            ...
            tabIndex={-1}
            onKeyDown={(e) => e.key === "Escape" && setChargeDebt(null)}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sheet-handle" />
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  opacity:
                    !chargeAmount || parseFloat(chargeAmount) <= 0 ? 0.5 : 1,
                }}
              >
                Ajouter la charge
              </button>
