...
export default function SectionsClient({ sections: initial }: { sections: Section[] }) {
  ...
  function openCreate() {
    setName(''); setIcon('🏠'); setColor(COLORS[0].value);
        ...
        {sections.length === 0 ? (
          ...
          <div style={{
            ...
            <p style={{
              ...
              Les sections organisent tes dépenses par catégorie (Maison, Transport, Loisirs…)
            </p>
            <button
              onClick={openCreate}
              style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {sections.map((section, i) => (
              <div
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLElement).style.borderColor = 'rgba(15, 118, 110, 0.2)';
              ...
              >
                {/* Drag handle */}
                <div className="drag-handle" style={{ color: 'var(--border-strong)', flexShrink: 0, touchAction: 'none' }}>
                ...
                {deleting === section.id ? (
                  <div className="confirm-inline">
                    <span style={{ color: 'var(--text-tertiary)', fontSize: '13px' }}>Supprimer ?</span>
                  ...
                  {EMOJIS.map((e) => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 'var(--radius-sm)',
                        background: icon === e ? 'var(--accent-subtle)' : 'var(--surface-sunken)',
                        cursor: 'pointer',
