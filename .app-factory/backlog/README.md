...
Features: 18 existing | Stories: 14 FIX (5 BLQ + 9 MIN) | Status: READY
...
| configuration | 5 | BLQ-001 (shared), MIN-005 |
...
1. **Wave 1** : MIN-004, BLQ-001, BLQ-002, BLQ-003
2. **Wave 2** : BLQ-004, BLQ-005
3. **Wave 3** : MIN-001 → MIN-007
4. **Wave 4** : MIN-008, MIN-009

## Quick Reference

- Feature briefs: `epics/[epic]/features/[feature]/feature-brief.md`
